<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1"
 import="entidades.Region, datos.Dt_Region, entidades.Pais, datos.Dt_Pais, java.util.*;" %>
<!DOCTYPE html>
<html lang="en">
...
<body id="page-top">
        ...
        <!-- Menus -->
  		 <jsp:include page="adminMenus.jsp" />    
                ...
                <div class="container-fluid">
                                <%
                            	String rgID = "";
							 	rgID= request.getParameter("idR")==null?"0":request.getParameter("idR");
														
								Region rg = new Region();
								Dt_Region dtr = new Dt_Region();
								rg = dtr.getRegion(Integer.parseInt(rgID));						
                         	   %>
                    <!-- Formulario -->
                      <div class="container">
                        <div class="row ">
                            <div class="col-lg-10 mx-auto m-auto">
                                <div class="card rounded shadow border-0">
                                    ...
                                    <div class="card-body bg-white rounded">                           
                                        <form role="form" class = "Region" method="post" action="./Sl_GestionRegion">
    ...
    <script>  
	  $(document).ready(function()
		{
			$("#txtNombreRegion").val("<%=rg.getNombre()%>");
			$("#txtDescripcionRegion").val("<%=rg.getDescripcion()%>");
			$("#txtNombrePais").val("<%=rg.getPaisID()%>");			
