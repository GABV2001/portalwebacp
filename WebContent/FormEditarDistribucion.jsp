...
import="vistas.ViewDistribucion,datos.Dt_Distribucion, entidades.Distribucion,entidades.Rol,vistas.ViewRolUsuario,datos.Dt_Pais, entidades.Pais,vistas.ViewPais, vistas.ViewRolOpcion, datos.Dt_Rol,datos.Dt_RolOpcion,java.util.*;" %>
<%
	  ...
	  $(document).ready(function()
		{
			...
			$("#txtNombrePais").val("<%=ds.getPaisID()%>");		 
		});
	 </script>  
</body>
</html>